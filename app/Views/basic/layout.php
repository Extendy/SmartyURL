...
<div class="app-wrapper">
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-block d-sm-none d-md-none d-lg-none d-xl-none">
                    <a href="/url/new" class="btn btn-primary"><i
                            class="bi bi-plus-lg"></i> <?= lang('Url.addNewURLMainShortbtn'); ?></a>
                </li>
                            ...
                            <div class="row">
                                <div class="col-12 text-center">
                                    ...
                                    <a class="btn btn-secondary btn-sm" href="<?= site_url('account/changepwd'); ?>">
                                        <i class="bi bi-person-fill-gear"></i> <?= lang('Common.accountSettingsLnk'); ?>
                                    </a>
                                </div>
    ...
    <footer class="app-footer">
        <!--begin::To the end-->
        <div class="float-end d-none d-sm-inline"><?= config('Smarty')->smarty_name; ?> <a target="_blank"
                                                                                           rel="nofollow"
                                                                                           href="<?= config('Smarty')->smarty_online_repo; ?>">v<?= config('Smarty')->smarty_version; ?></a>
        </div>
        <!--end::To the end-->
        <!--begin::Copyright-->
        <strong>
